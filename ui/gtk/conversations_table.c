    ...
    tap_packet_cb packet_func)
{
    ...
    conversations->default_titles[4]="SVC";
    conversations->default_titles[5]="Packets";
    conversations->default_titles[6]="Bytes";
    conversations->default_titles[7]="Packets A" UTF8_RIGHTWARDS_ARROW "B";
    conversations->default_titles[8]="Bytes A" UTF8_RIGHTWARDS_ARROW "B";
    conversations->default_titles[9]="Packets A" UTF8_LEFTWARDS_ARROW "B";
    conversations->default_titles[10]="Bytes A" UTF8_LEFTWARDS_ARROW "B";
    conversations->default_titles[11]="Rel Start";
    conversations->default_titles[12]="Duration";
    conversations->default_titles[13]="bps A" UTF8_RIGHTWARDS_ARROW "B";
    conversations->default_titles[14]="bps A" UTF8_LEFTWARDS_ARROW "B";
